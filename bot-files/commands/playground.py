    ...
    async def playground(self, interaction: discord.Interaction) -> None:
        ...
        try:
            ...
            embed.add_field(
                ...
                value=(
                    "**🎯 Tier List Creator** - Create your own ranking for tanks, maps and agents\n"
                    "**⚙️ Game Configurator** - Customize your World of Tanks: HEAT experience\n"
                    "**🎲 Tank Roulette** - Spin the roulette to get a random tank to play\n"
                    "**🖥️ Game Servers** - Live tracking for all World of Tanks: HEAT game servers\n"
                    "**📱 HEAT Labs Application** - Download our app on your Phone or Desktop\n"
                    "**📝 Wordle Game** - World of Tanks: HEAT inspired Wordle game\n"
                    "**🔊 Soundboard** - Listen to all sounds from World of Tanks: HEAT\n"
                    "**⏰ Alpha 3 Countdown** - Countdown for the launch of Alpha 3 playtest\n"
                ),
                inline=False,
            )
            ...
            embed.add_field(
                name="🔗 Quick Access",
                value=(
                    "• Visit our [Playground Website](https://heatlabs.net/playground) for the full experience\n"
